    ...
    <article className="group overflow-hidden bg-[#fffdf8] shadow-[0_16px_50px_rgba(23,51,38,.07)]">
      ...
      <div className="p-5 sm:p-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="mb-2 flex items-center gap-1.5 text-xs text-[#647368]"><MapPin className="size-3.5 text-[#b99751]" /> {property.location} · {property.distance} км від Луцька</div>
        ...
        <p className="mt-4 text-xl font-semibold text-[#173326]">{formatPrice(property.price)}</p>
