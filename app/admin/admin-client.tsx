...
export function AdminClient({ initialItems, initialError, adminEmail }: Props) {
  ...
  const updateVideoUrls = (value: string) =>
    setDraft((current) => ({
      ...current,
      attributes: {
        ...current.attributes,
